...
import { Box, Collapse, Container, Divider, Grid, Typography, useMediaQuery } from '@mui/material'
    ...
    return (
        <LayoutCentered image={titleImg} title='Incoterms' pageTitle='Incoterms' customHeight='35vw'>
            <Box sx={{ my: theme.spacing(3), mx: { xs: 0, sm: theme.spacing(1), md: theme.spacing(8) } }}>
                ...
                <Typography variant='h4' textAlign='justify' sx={{ color: '#031225', fontWeight: 600, mt: theme.spacing(3) }}>
